...
— **Reasoning.** `decisions-ledger.md` D-01 (the case for), §3.3.2 (the case against, left standing), §3.3.3
...
— **Reasoning.** `decisions-ledger.md` D-01, D-02.
...
Open item `decisions-ledger.md` §6 item 1, with a defined trigger rather than a date.
— **Settled.** P1 gate, 2026-08-08.
— **Reasoning.** `decisions-ledger.md` D-01; D-168.
...
— **Reasoning.** `docs-site.md` §3.4; `docs-site.md` §1.6.
...
— **Reasoning.** `CLAUDE.md`, *reference checkouts*; `zag-solid-adapter.md` §2.3, §2.4.
...
— **Reasoning.** `plan.md` §0, §0.4; `docs-site.md` §3.4; `docs-plan.md` §5.4.
...
unenforced.
— **Settled.** P1 gate, 2026-08-08.
— **Reasoning.** `CLAUDE.md`, *Reference use*; `definition-of-done.md` §7.1, §7.2.
...
— **Reasoning.** `CLAUDE.md`, *Reference use*; `decisions-ledger.md` §6; `plan.md` §3.3.
...
— **Settled.** P1 gate.
— **Reasoning.** `CLAUDE.md`, the five obligations.
...
— **Reasoning.** `testing.md` §11; `testing.md` §11; `definition-of-done.md` §9.
