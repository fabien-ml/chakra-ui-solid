...
— **Reasoning.** `decisions.md` D-01 (the case for), §3.3.2 (the case against, left standing), §3.3.3
...
— **Reasoning.** `decisions.md` D-01, D-02.
...
Open item `decisions.md` §6 item 1, with a defined trigger rather than a date.
— **Settled.** P1 gate, 2026-08-08.
— **Reasoning.** `decisions.md` D-01; D-168.
...
— **Reasoning.** `CLAUDE.md`, *Reference use*; `decisions.md` §6; `plan.md` §3.3.
