...
`decisions-ledger.md` §5. Cost is real and is accepted: every component phase now carries its page, and
...
left: the machinery and guide tier (`/guides/static-extraction`, migration, theming, `defineChakraConfig`),
