...
closes it, and no check reports it missing.** It returns alongside `decisions.md` D-168's launch
trigger, which fires at the same moment and for the same reason: both are about the site having
readers.
— **Settled.** S3b, 2026-08-09, by the reviewer's direction.
— **Reasoning.** `docs-site.md` §2.2, §4.6; `docs-plan.md` §4.4; `decisions.md` D-168.
...
— **Reasoning.** `docs-site.md` §2.2; `roadmap.md` §4, §5; `plan.md` §0.4; `decisions.md` D-02.
...
private (`decisions.md` D-02), so every `source` link on the site would 404.
...
— **Settled.** S3b part 3, 2026-08-09.
— **Reasoning.** `docs-plan.md` §8.1; `decisions.md` D-01, D-02.
