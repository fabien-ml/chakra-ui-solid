...
§4.6; **D-138**), on the same trigger as `decisions-ledger.md` D-168's maintainer message, because the audience
...
| Verbatim | Why there |
|---|---|
| **The README's first paragraph** | The npm package page is where a mistaken install begins (`decisions-ledger.md` D-01 item 1) |
...
| `chakra` | **the upstream page for the same component.** An outward link, and `decisions-ledger.md` D-01 item 2 makes it a virtue rather than a courtesy: a reader who wanted the official project should leave in one click |
