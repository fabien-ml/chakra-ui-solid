...
> **The subject of this section is gone.** All five repo-authored skills went in the 2026-08-10
> apparatus cut, along with `check:skill-pointers` and the `INDEX.md`/`docs:index` pair §8.1's
> remedy names (`CLAUDE.md`). `.agents/skills/` today holds three third-party skills and nothing
> this section describes. Kept as the record of the citation grammar and the two shape rules —
> **not as a spec to rebuild them from.**
