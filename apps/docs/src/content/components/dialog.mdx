...
Dialogs can be triggered from within a popover. The dialog will appear above the popover thanks to
the unified z-index system.

<Example name="dialog-open-from-popover" />

### Initial Focus

Use the `initialFocusEl` prop to set the initial focus of the dialog component.

<Example name="dialog-with-initial-focus" />
...
<Example name="dialog-with-datalist" />
