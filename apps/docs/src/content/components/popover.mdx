...
<PropsTable component="popover" interface="PopoverRootProviderProps" />

### Trigger

<PropsTable component="popover" interface="PopoverTriggerProps" />

### Context

<PropsTable component="popover" interface="PopoverContextProps" />

### createPopover

<PropsTable component="popover" interface="CreatePopoverProps" />
