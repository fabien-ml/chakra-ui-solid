...
links:
  source: packages/chakra-ui-solid/src/components/tag
  chakra: https://chakra-ui.com/docs/components/tag
---
...
> This is particularly useful when dealing with dynamic or user-generated content where the length
> might vary.

<Example name="tag-with-overflow" />
...
<Example name="tag-with-avatar" />

### Render as button

Use the `render` prop to render the tag as a button.

<Example name="tag-as-button" />

### Closed Component

Here's how to setup the Tag for a closed component composition.

<Example name="tag-closed-component" />

## Props

### Root

<PropsTable component="tag" interface="TagRootProps" />
