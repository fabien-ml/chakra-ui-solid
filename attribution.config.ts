...
const docsApp: AttributionEntry[] = [
  ...
  {
    // One entry for thirty-nine glyphs, on the reasoning that makes `apps/docs/src/content` one row
    ...
    //
    // The only ISC entry, and the only one owing a *second* upstream: twenty of the thirty-nine are
