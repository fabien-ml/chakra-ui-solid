# Third-party notices — `@chakra-ui-solid/preset`
...
matches [`__internal__/legal.md`](https://github.com/fabien-ml/chakra-ui-solid/blob/main/__internal__/legal.md) §2.
...
**dependency** of this package, not vendored into it. Everything here is a key added on top of it:
`staticCss` declarations, `jsx` tracking hints, one `cursor` token, and any shorthand alias Panda
does not already provide. No recipe body and no token table is re-emitted.
